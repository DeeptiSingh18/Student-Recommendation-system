...
1) The user enters their:
     i) Interset (Coding, Management, Design)
    ii) Strength (Math, Communication, Creativity)
   iii) Marks
    iv) Preffered Subject

2) Each input contributes to scores assigned to different career options.
